...
export class Rule extends Lint.Rules.AbstractRule {
    ...
    public static readonly ADD_SPACE_AFTER_IMPORT = "Add space after 'import'";
    public static readonly TOO_MANY_SPACES_AFTER_IMPORT = "Too many spaces after 'import'";
    public static readonly ADD_SPACE_AFTER_STAR = "Add space after '*'";
    public static readonly TOO_MANY_SPACES_AFTER_STAR = "Too many spaces after '*'";
    public static readonly ADD_SPACE_AFTER_FROM = "Add space after 'from'";
    public static readonly TOO_MANY_SPACES_AFTER_FROM = "Too many spaces after 'from'";
    public static readonly ADD_SPACE_BEFORE_FROM = "Add space before 'from'";
    public static readonly TOO_MANY_SPACES_BEFORE_FROM = "Too many spaces before 'from'";
    public static readonly NO_LINE_BREAKS = "Line breaks are not allowed in import declaration";
